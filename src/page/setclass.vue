<template>
  <div class="home-container ">
    ...
    <selectPage v-if="selectShowIf" :show="popShow" :text="searchKey" @closeSelect="popShow=false" @setItem="setClassItem"></selectPage>
  </div>
</template>
...
export default {
  ...
  methods : {
    ...
    save(){
      this.$dialog.confirm({
        title: '',
        message: '<img src="../assets/img/i8.png"><div>提交成功</div>',
        allowHtml:true,
        confirmButtonText:'继续添加',
        cancelButtonText:'不用了',
        confirmButtonColor:'#2E6CFF',
        // cancelButtonColor:"#F5F6FE"
      })
        .then(() => {
          // on confirm
        })
